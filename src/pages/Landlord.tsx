...
const LandlordFormClone: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      ...
      >
        <h2 className="text-2xl font-bold mb-1 text-gray-800">Landlord Form</h2>
        <p> This is landlord information.</p>
...
export default LandlordFormClone;
